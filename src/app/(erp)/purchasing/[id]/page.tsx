...
const STATUS_COLORS: Record<string, string> = {
  draft: "badge-slate", sent: "badge-blue", partial: "badge-amber", 
      ...
      <div className="page-header" style={{ marginBottom: 0 }}>
        <div>
          ...
          <p className="page-subtitle">
            Supplier: <span style={{ fontWeight: 500, color: "var(--text-primary)" }}>{order.supplier.name}</span>
          </p>
        </div>
        ...
        <div className="card" style={{ gridColumn: "span 2", display: "flex", flexDirection: "column", gap: "1.25rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem" }}>
            ...
            <div>
              ...
              <div style={{ fontSize: "0.875rem", fontWeight: 500 }}>{order.expectedDate ? new Date(order.expectedDate).toLocaleDateString("en-IN") : "—"}</div>
            </div>
            ...
            <table style={{ minWidth: "100%" }}>
              <thead>
                <tr>
                  ...
                  <th style={{ textAlign: "right" }}>Recv'd</th>
